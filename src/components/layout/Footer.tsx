  ...
  return (
    <footer className="border-t bg-background mt-auto">
      <div className="container py-8 md:py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Decentralized medical records platform powered by blockchain technology.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/signin" className="text-sm text-muted-foreground hover:text-primary transition-colors">Sign In</Link></li>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="space-y-2">
              <li className="text-sm text-muted-foreground">support@healthdecentro.com</li>
        ...
        <div className="mt-8 pt-6 border-t flex flex-col-reverse gap-4 md:flex-row md:items-center md:justify-between text-center md:text-left">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} HealthDecentro. All rights reserved.
          </p>
